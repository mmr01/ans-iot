...
SELECT * FROM  dbo.metrics_insert
SELECT * FROM dbo.metrics_select
...
avg_elapsed_time_ms, avg_worker_time_ms, logical_reads_per_one_select AS logical_reads_per_one_select
