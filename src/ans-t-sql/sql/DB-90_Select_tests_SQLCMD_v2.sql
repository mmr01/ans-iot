...
SELECT 1, 'Not compressed',@numberOfTemperaturesInOneRow, (SELECT COUNT(1) FROM dbo.t_readouts_raw), 
qs.[sql_handle], [text], 
...
--Display metrics:
INSERT INTO dbo.metrics_select 
SELECT 2,'DECOMPRESS',@numberOfTemperaturesInOneRow, (SELECT COUNT(1) FROM dbo.t_readouts_compress),
qs.[sql_handle], [text], 
execution_count, last_execution_time, 
total_worker_time/1000 AS total_worker_time_ms,
total_worker_time/execution_count/1000 AS avg_worker_time_ms,
...
BEGIN
	...
	rea_audit_cd, 
	--rea_sequence,
	dbo.f_ans_decode(rea_temperatures,@numberOfTemperaturesInOneRow) AS rea_temperatures
	,rea_rssi
	--rea_voltage
...
--Display metrics:
INSERT INTO dbo.metrics_select 
SELECT 3, 'ANS_TSQL',@numberOfTemperaturesInOneRow, (SELECT COUNT(1) FROM dbo.t_readouts_raw_ans),
qs.[sql_handle], [text], 
execution_count, last_execution_time, 
total_worker_time/1000 AS total_worker_time_ms,
total_worker_time/execution_count/1000 AS avg_worker_time_ms,
...
BEGIN
	...
	rea_audit_cd, 
	--rea_sequence,
	dbo.ANSDecode(rea_temperatures,@numberOfTemperaturesInOneRow) AS rea_temperatures
	,rea_rssi
	--rea_voltage
	FROM t_readouts_raw_ans OPTION (MAXDOP 1);
	SET @currentRecord += 1;
...
--Display metrics:
INSERT INTO dbo.metrics_select 
SELECT 4, 'ANS_C#',@numberOfTemperaturesInOneRow, (SELECT COUNT(1) FROM dbo.t_readouts_raw_ans),
qs.[sql_handle], [text], 
execution_count, last_execution_time, 
total_worker_time/1000 AS total_worker_time_ms,
total_worker_time/execution_count/1000 AS avg_worker_time_ms,
